...
export async function SiteFooter() {
  ...
  return (
    <footer className="py-8 px-6 border-t border-[#2C1E16]/8 mt-auto">
      <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-3 gap-5 text-xs text-[#2C1E16]/45">

        {/* brand */}
        <div className="flex flex-col gap-1.5">
          <span className="font-heading text-sm text-[#2C1E16]/55 tracking-wide font-semibold">
            Cava Bar
          </span>
        ...
        <div className="flex flex-col gap-1.5 sm:text-center">
          <span className="font-semibold text-[#2C1E16]/35 uppercase tracking-wide text-[10px]">
            Графік роботи
          </span>
          {hours.split("\n").map((line, i) => (
