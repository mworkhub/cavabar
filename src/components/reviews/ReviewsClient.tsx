...
function ReviewCard({ review }: { review: Review }) {
  return (
    <article className="bg-[#FAF8F5] rounded-2xl p-6 border border-[#E8DDD3] flex flex-col gap-3
                        transition-all duration-300 hover:-translate-y-1.5 hover:shadow-xl hover:shadow-[#C68E58]/10">
        ...
        <aside className="lg:col-span-1 mb-12 lg:mb-0">
          <div className="lg:sticky lg:top-[80px] flex flex-col gap-8">
            ...
            <div className="flex flex-col gap-3">
              <button
                onClick={openModal}
                className="self-start px-7 py-3.5 rounded-full text-sm font-medium
                           border border-[#C68E58] text-[#C68E58]
                           hover:bg-[#C68E58] hover:text-white
              ...
              <a
                ...
                className="self-start inline-flex items-center gap-1.5 px-7 py-3.5 rounded-full text-sm font-medium
                           border border-[#2C1E16]/25 text-[#4A3428]
        ...
        <div className="lg:col-span-2">
          {reviews.length === 0 ? (
            <div className="rounded-2xl bg-[#F2EAE0] border border-[#C68E58]/15 p-10 text-center">
              ...
              <p className="text-[#4A3428] text-sm leading-relaxed mb-6">
